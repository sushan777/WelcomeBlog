"""
Django settings for WelcomeBlog project.
...
SECRET_KEY = 'django-insecure-f06#@$8(-hmdv=8)(+_+tq*!o@#!4oy@kyjcklel0h7!z8z_)t'
...
WSGI_APPLICATION = 'WelcomeBlog.wsgi.application'
